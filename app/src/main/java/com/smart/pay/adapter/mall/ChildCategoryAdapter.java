...
public class ChildCategoryAdapter extends BaseAdapter {
    ...
    ArrayList<GetCategoryDetailOutputModel.ChildCategory> bean;
    AppCompatActivity main;


    public ChildCategoryAdapter(AppCompatActivity activity, ArrayList<GetCategoryDetailOutputModel.ChildCategory> bean) {
        this.main = activity;
        this.bean = bean;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final GetCategoryDetailOutputModel.ChildCategory bean = (GetCategoryDetailOutputModel.ChildCategory) getItem(position);
