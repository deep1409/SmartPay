...
public class CategoryProductAdapter extends BaseAdapter {
    ...
    ArrayList<GetCategoryDetailOutputModel.Product> bean;
    ...
    public CategoryProductAdapter(AppCompatActivity activity, ArrayList<GetCategoryDetailOutputModel.Product> bean) {
        this.main = activity;
        this.bean = bean;
    }
...
//
        ...
        final GetCategoryDetailOutputModel.Product bean = (GetCategoryDetailOutputModel.Product) getItem(position);
