...
public class GridviewAdapter2 extends BaseAdapter {
    ...
    ArrayList<FlashDealsProductsOutputModel.Product> bean;
    ...
    public GridviewAdapter2(AppCompatActivity activity, ArrayList<FlashDealsProductsOutputModel.Product> bean) {
        this.main = activity;
        this.bean = bean;
    }
...
//
        ...
        final FlashDealsProductsOutputModel.Product bean = (FlashDealsProductsOutputModel.Product) getItem(position);
