...
public class ListviewAdapter2 extends BaseAdapter {
    ...
    public ListviewAdapter2(AppCompatActivity activity, ArrayList<FlashDealsProductsOutputModel.Product> bean) {
...
//
        ...
        FlashDealsProductsOutputModel.Product bean = (FlashDealsProductsOutputModel.Product) getItem(position);
